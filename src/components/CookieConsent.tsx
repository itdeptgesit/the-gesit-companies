                ...
                >
                    <div className="bg-white/95 backdrop-blur-md p-6 rounded-card border border-slate-200 shadow-2xl pointer-events-auto">
                        <div className="flex items-start gap-4">
                            <div className="w-10 h-10 rounded-full bg-[#BC9C33]/10 flex items-center justify-center text-[#BC9C33] shrink-0">
                                <Cookie size={20} />
                            </div>
                            <div className="flex-1">
                                <h4 className="font-display font-bold text-navy-deep text-sm">We use cookies</h4>
                                <p className="text-[10px] text-slate-500 mt-2 leading-relaxed">
                                    We use cookies to analyze site traffic and enhance your user experience. By continuing, you agree to our use of cookies. <a href="/cookie-policy" className="text-navy-deep hover:text-[#BC9C33] underline decoration-slate-300 underline-offset-2 transition-all">Read our Cookie Policy</a>
                                </p>
                            </div>
                            <button
                        ...
                        <div className="mt-4 flex justify-end gap-3">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-navy-deep text-white text-[10px] font-bold uppercase tracking-widest rounded-full hover:bg-[#BC9C33] transition-colors shadow-lg"
                            >
                                Accept
                            </button>
                        </div>
