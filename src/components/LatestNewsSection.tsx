                            ...
                            <Link to={`/news/${item.id}`} className="group block">
                                ...
                                <div className="space-y-5 px-2">
                                    ...
                                    <div className="relative">
                                        <h3 className="text-2xl font-display leading-tight text-navy-deep group-hover:text-[#BC9C33] transition-colors duration-500 line-clamp-2 pb-2">
                                            {item.title}
                                        </h3>
                                        <div className="absolute bottom-0 left-0 w-0 h-[2px] bg-[#BC9C33] group-hover:w-1/4 transition-all duration-500"></div>
                                    </div>
