        ...
        <div className="bg-slate-50 min-h-screen font-body text-navy-deep overflow-hidden relative">
            ...
            <div className="container mx-auto px-6 max-w-7xl -mt-20 relative z-20 pb-24">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
                    <motion.div
                        {...fadeIn}
                        className="lg:col-span-7 bg-white rounded-card p-8 md:p-16 shadow-2xl shadow-slate-200/50"
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border border-slate-100 px-6 py-4 rounded-input outline-none focus:ring-4 focus:ring-[#BA9B32]/10 focus:bg-white focus:border-[#BA9B32]/50 transition-all placeholder:text-slate-300"
                                    />
                                </div>
                                <div className="space-y-3">
                            ...
                            <div className="space-y-3">
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-slate-50 border border-slate-100 px-6 py-4 rounded-input outline-none focus:ring-4 focus:ring-[#BA9B32]/10 focus:bg-white focus:border-[#BA9B32]/50 transition-all placeholder:text-slate-300 resize-none"
                                ></textarea>
                            </div>
                    ...
                    <div className="lg:col-span-5">
                        ...
                        >
                            ...
                            <div className="relative overflow-hidden rounded-card shadow-xl group aspect-[3/4] lg:aspect-auto lg:h-[30rem] shrink-0">
                                <img
                                    src="/contact/contact.png"
                                    alt="Gesit Professional"
                                    className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-150 scale-125"
