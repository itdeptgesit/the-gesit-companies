    ...
    return (
        <div ref={containerRef} className="bg-white font-body selection:bg-[#BC9C33] selection:text-white">
            ...
            <section className="bg-[#103065] py-24 md:py-36">
                <div className="max-w-[1150px] mx-auto px-8 md:px-16">
                    <motion.div
                        initial={{ opacity: 0, y: 30 }}
            ...
            {/* 3. Philosophy Section - Editorial Layout (Stacked) */}
            <section className="bg-[#e3eaf4] py-16 md:py-28 overflow-hidden text-center lg:text-left">
                <div className="max-w-[1150px] mx-auto px-8 md:px-16 lg:px-20">
                    {/* 艺成 SVG */}
                    <motion.div
                    ...
                    >
                        <p
                            className="text-[#103065] mb-12"
                            style={{ fontFamily: "'Source Sans Pro', sans-serif", fontSize: '21px', fontWeight: 400, lineHeight: '1.6' }}
                        >
                            Based on the Mandarin <i><b>"yi cheng"</b></i> and Hokkien <i><b>"geseng"</b></i>, which means <i><b>"perfection for art"</b></i>
                        </p>

                        <h4
                            className="text-[#BC9C33] text-3xl md:text-5xl mb-12"
                            style={{ fontFamily: "Georgia, serif", fontWeight: 400, lineHeight: '1.3' }}
                        >
                    ...
                    <motion.div
                        ...
                        className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8 text-[#103065] text-left"
                        style={{ fontFamily: "'Source Sans Pro', sans-serif", fontSize: '19px', fontWeight: 400, lineHeight: '1.55' }}
                    >
